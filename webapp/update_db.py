...
def save_news_db(titleEs, url, fecha, shorttextEs, textEs):
    ...
    if not news_exists:
        new_news = News(titleEs=titleEs,
                        titleRu=get_translate(titleEs, "es-ru"),
                        titleEn=get_translate(titleEs, "es-en"),
                        url=url,
                        fecha=fecha,
                        shorttextEs=shorttextEs,
                        shorttextRu=get_translate(shorttextEs, "es-ru"),
                        shorttextEn=get_translate(shorttextEs, "es-en"),
                        textEs=textEs,
                        textRu=get_translate(textEs, "es-ru"),
                        textEn=get_translate(textEs, "es-en"))
